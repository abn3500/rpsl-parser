...
public class AppTest {
	...
	public void testInitialisation() throws IOException {
		...
		final String argSample[] = {"-i", inputPath.toString(), "-o", outputPath.toString(), "-e", XMLEmitter.class.getName(), "-m", "a=1", "-m", "b=2"};

		app.setup(argSample);

		assertTrue(app.inputPath.equals(inputPath.toString()));
		assertTrue(app.outputPath.equals(outputPath.toString()));
		assertTrue(app.emitterName.equals(XMLEmitter.class.getName()));
		//System.out.println(app.emitter.getClass().getName());
		assertTrue(app.emitter instanceof XMLEmitter);
		...
		assertTrue(app.writer.outputEmitter instanceof XMLEmitter);
	}

	@Test
	public void testXMLOutput() throws IOException {
		final String argSample[] = {"-i", inputPath.toString(), "-o", outputPath.toString(), "-e", XMLEmitter.class.getName()};

		app.setup(argSample);

		assertTrue(app.emitterName.equals(XMLEmitter.class.getName())); //check emitter name was extracted correctly from input
