...
public class BGPPeer {
	...
	protected String peerAutNum, peerAddress, peerRegistry, name;
	 ...
	 */
	public BGPPeer(String peerAutNum, String peerAddress, BGPInetRtr speaker) {
		...
		this.name = String.format("%s(%s)-peer-of-%s(%s)", peerAutNum, peerAddress, speaker.autNumObject.name, speaker.speakerAddress);
	...
	public boolean equals(Object o) {
		...
		return this.speaker.equals(other.speaker) && this.peerAddress.equals(other.peerAddress) && this.peerAutNum.equals(other.peerAutNum);	
	}
